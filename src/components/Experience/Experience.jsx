        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-2">
          ...
          <div className="flex flex-wrap justify-center md:justify-start md:w-2/5 gap-4 md:gap-5 md:p-12 py-10">
            {techStack.map((tech, index) => (
              <div
                key={index}
                className={`group relative p-3 bg-zinc-950 rounded-2xl cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-purple-500/50 hover:bg-gradient-to-br hover:from-purple-900/30 hover:to-pink-900/30 ${
          ...
          <div className="w-full md:w-[500px]">
            <div className="text-white bg-slate-950 bg-opacity-45 rounded-lg p-4 border border-purple-500/20">
              <ul className="list-disc pl-5 text-sm md:text-base leading-relaxed space-y-2">
                <li>
                  Full Stack MERN Developer with 1+ year of hands-on experience in
                  building responsive and scalable web applications.
                </li>
                <li>
                  Completed a 4-month internship, working on real-world projects
                  involving both frontend and backend development.
                </li>
                <li>
                  Strong experience in React.js, JavaScript, HTML, CSS, and
                  Tailwind CSS for building modern and user-friendly interfaces.
                </li>
                <li>
                  Hands-on experience with Node.js, Express.js, MongoDB and
                  PostgreSQL for developing RESTful APIs and backend logic.
                </li>
                <li>
                  Implemented authentication, authorization, CRUD operations, and
                  API integrations.
                </li>
                <li>
                  Worked closely with UI/UX designs to ensure performance,
                  responsiveness, and clean code structure.
                </li>
                <li>
                  Experienced in debugging, optimizing performance, and
...
//   return (
//     <div id="Experience" className="p-6 md:p-24" ref={sectionRef}>
//       <h1 className="text-3xl md:text-5xl font-bold mb-12 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
//         Experience
//       </h1>
//       <div className="flex flex-col md:flex-row items-center justify-between gap-2">
